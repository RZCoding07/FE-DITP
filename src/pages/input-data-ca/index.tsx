...
export default function AddUraianPekerjaanForm() {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            ...
            await axios.post(`${apiUrl}/ca`, transformedData)
    ...
    return (
        <Layout>
            ...
            <Layout.Body>
                <Card>
                    <CardHeader>
                        <CardTitle>Tambah Data Corrective Acton</CardTitle>
                        <CardDescription>Tambahkan data corrective action</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form {...form}>
