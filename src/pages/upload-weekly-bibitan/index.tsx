...
export default function UploadWeeklyBibitan() {
      ...
      const uploadData = async () => {
        const mappedDataPromises = values.map(async (value) => {
          return {
            ...
            // k: value[11], // k
            // l: value[12], // l
            keterangan: value[13], // keterangan
            dari_tanggal: value[14], // dari_tanggal
            sampai_tanggal: value[15], // sampai_tanggal    
  ...
  const handleUploadWeeklyBibitans = async () => {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      uploadPromises.push(
        fetch(`${apiUrl}/weekly-bibitan/upload`, {
          method: 'POST',
          headers: {
  ...
  return (
    <Layout>
      ...
      <Layout.Body>
        <Card>
          <CardHeader>
            <CardTitle>Upload Weekly Bibitan</CardTitle>
          </CardHeader>
          <CardContent>
            <button
            ...
            <div className='mt-5 grid'>
              ...
              <div className='mt-5 flex items-center justify-end gap-3'>
                ...
                {!isLoadingUpload ? (
                  <button
                    onClick={() => handleUploadWeeklyBibitans()}
