...
const complianceStats = monevDetail?.data.kertas_kerja
  ...
  if (isLoading) {
    return (
      <div className=" bg-gradient-to-br from-slate-900 to-slate-900 flex items-center h-full justify-center">
  ...
  if (error || !data) {
    return (
      <div className="h-full bg-gradient-to-br from-slate-900 to-slate-900 flex items-center justify-center">
